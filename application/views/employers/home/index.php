  ...
  <div class="container text-center">
    <div class="row">
     <div class="col-md-12 col-lg-12">
      ...
      <h3 class="main-title">Access 1000 CVs</h3>
    </div> 
    ...
    <div class="row">
      ...
      <div class="col-md-3 pb-2">
	   ...
	   <div class="col-md-3 pb-2">
        ...
        <h5 class="pt-3">Login</h5>
        <a href="<?= base_url(); ?>employers/auth/login" class="btn btn-outline-primary mt-3" role="button"> Employer Login</a>
      </div>
    </div>
  </div>
</section>
...
<section class="emp-why-us">
  <div class="container text-center">
    <div class="row">
      <div class="col-md-12">
        <h1 class="section-title">Why JagirGhar.com?</h1>
        <div class="line-title"></div>
        <h5 class="pt-3">Nepal's Largest community of job seekers. Fast, easy, cost-effective. Customer-first attitude.</h5>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4 mt-5">
        ...
        <p>Reach the Nepal's  largest community of job seekers in the Middle East, from across all industries and career levels. Growing at over 12,000 a day.</p>
      </div>
      <div class="col-md-4 mt-5">
