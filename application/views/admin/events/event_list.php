  ...
  <div class="col-lg-12">
    ...
    <section  class="panel">
      <div class="panel-body">
          <h4 class="head3" style="display: inline-block;"> <strong>Manage Events</strong></h4> 
          <div class="button-inline pull-right">
              <a href="<?= base_url('admin/events/event_add')?>" class="btn btn-primary"><span class="fa fa-plus"></span>&nbsp;&nbsp;Add Events</a>
          </div>
      </div>
    </section>
...
//---------------------------------------------------
	var table =	$('#na_datatable').DataTable( {
			"processing": true,
			"serverSide": true,
			"ajax": "<?=base_url('admin/events/datatable_json')?>",
			"order": [[4,'desc']],
			"columnDefs": [
