...
<html lang="en">
    <head>
          <title><?=isset($title)?$title:'Jagir Ghar-Admin Panel' ?></title>
          <!-- Tell the browser to be responsive to screen width -->
          <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
          <!-- Bootstrap 3.3.6 -->
		  <link rel="shortcut icon" href="<?= base_url() ?>assests/img/a03639f75a32f870648798af900183f8.png">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 text-center">
                    ...
                    <?php endif; ?>
                    <div class="form-box">	
							<img src="<?= base_url() ?>assets/img/logo1.png" id="icon" class="responsive" alt="Jagir Ghar Logo">
